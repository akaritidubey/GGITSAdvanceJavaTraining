...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements webDynamic.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8891/webDynamic/services/Calculator";
    ...
    public webDynamic.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public webDynamic.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webDynamic.CalculatorSoapBindingStub _stub = new webDynamic.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webDynamic.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                webDynamic.CalculatorSoapBindingStub _stub = new webDynamic.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webDynamic", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webDynamic", "Calculator"));
        }
